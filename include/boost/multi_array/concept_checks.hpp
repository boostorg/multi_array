...
namespace boost { namespace multi_array_concepts { namespace detail {
    ...
    struct idgen_helper
    {
        ...
        static void call(Array& a, IdxGen const& idgen, Call_Type c)
        {
    ...
    {
        template <typename Array, typename IdxGen, typename Call_Type>
        static void call(Array& a, IdxGen const& idgen, Call_Type)
        {
            a[idgen];
        }
    };
}}} // namespace boost::multi_array_concepts::detail

#include <boost/concept_check.hpp>
#include <boost/iterator/iterator_concepts.hpp>

namespace boost { namespace multi_array_concepts {
    ...
    struct ConstMultiArrayConcept
    {
        void constraints()
        {
//            BOOST_CONCEPT_ASSERT((CopyConstructibleConcept<Array>));
...
//            BOOST_CONCEPT_ASSERT((CopyConstructibleConcept<Array>));
            ...
            BOOST_CONCEPT_ASSERT((
                boost::OutputIterator<iterator,value_type>
            ));
        ...
        void const_constraints(Array const& a)
        {
//            value_type vt = a[id];
...
}} // namespace boost::multi_array_concepts
